	...
	class DiviMegaPro_Helper extends DiviMegaPro {
		...
		public static function prepareMenu( $key = NULL )
		{
			try {
				...
				if ( strpos( $key, "#divimegapro-" ) !== false ) {
		...
		public static function searchDMPs( $content = NULL ) {
			...
			try {
				...
				$divimegapros_found = $found_dmps_byid + $found_dmps_byclass_2 + $found_dmps_byhrefhash + $found_dmps_byurlhash + $found_dmps_onanyattr;

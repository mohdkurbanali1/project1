...
<div id="redoakcart-products-table"></div>
<script type="text/template" id="redoakcart-products-template">
...
<script type="text/javascript">
	$('#redoakcart-products-table').empty();
	$.each(all_levels, function(k, v) {
		var data = {
			label : post_types[k].labels.name,
			levels : v
		}
		var tmpl = _.template($('script#redoakcart-products-template').html(), {variable: 'data'});
		var html = tmpl(data);
		$('#redoakcart-products-table').append(html);
	});
</script>

	...
	test_keys : function(x) {
		...
		$.post(
			...
			function(result) {
				var toaster = {
					type : 'success',
					message : wlm.translate( 'Keys Saved' )
				};
				if(result.status) {
...
// 		}
	...
	load_products : function(products, clear) {
        ...
        $( '#authorizenet-arb-products-table .-del-btn' ).do_confirm( { confirm_message : wlm.translate( 'Delete this Product?' ), yes_button : wlm.translate( 'Delete' ) } ).on( 'yes.do_confirm', function() {

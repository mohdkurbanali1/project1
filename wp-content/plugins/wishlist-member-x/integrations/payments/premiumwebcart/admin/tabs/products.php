...
<div id="premiumwebcart-products-table"></div>
<script type="text/template" id="premiumwebcart-products-template">
...
<script type="text/javascript">
	$('#premiumwebcart-products-table').empty();
	$.each(all_levels, function(k, v) {
		var data = {
			label : post_types[k].labels.name,
			levels : v
		}
		var tmpl = _.template($('script#premiumwebcart-products-template').html(), {variable: 'data'});
		var html = tmpl(data);
		$('#premiumwebcart-products-table').append(html);
	});
</script>

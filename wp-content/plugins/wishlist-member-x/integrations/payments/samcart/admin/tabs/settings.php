...
<form>
	<div class="row">
		<template class="wlm3-form-group">
			{
				label : '<?php esc_js_e( 'Blog URL', 'wishlist-member' ); ?>',
				name : '',
				column : 'col-12 col-md-6',
				help_block : '<?php esc_js_e( 'Copy the Blog URL and paste it into SamCart in the following section:', 'wishlist-member' ); ?> <strong><?php esc_js_e( 'Settings > Integrations > New Integration > WishList Member.', 'wishlist-member' ); ?></strong>.',
		...
		<template class="wlm3-form-group">
			{
				name : '',
				column : 'col-12 col-md-6',
				help_block : '<?php esc_js_e( 'Copy the API Key and paste it into SamCart in the following section:', 'wishlist-member' ); ?> <strong><?php esc_js_e( 'Settings > Integrations > New Integration > WishList Member', 'wishlist-member' ); ?></strong>.',

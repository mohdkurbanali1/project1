<?php
/* Email Integration : AWeber Legacy */
...
printf( '<div class="form-text text-danger help-block"><p class="mb-0">%s</p></div>', 'This AWeber integration is now deprecated. It is strongly recommended to use the updated AWeber integration. <a href="?page=WishListMember&wl=setup/integrations/email_provider/aweberapi">Click here to do this now.</a>' );

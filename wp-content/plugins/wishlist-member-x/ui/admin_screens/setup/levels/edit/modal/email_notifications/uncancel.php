<div class="uncancel -holder">
	<div class="row">
		<div class="col-md-12">
			...
			label : '<?php esc_js_e( 'Enable', 'wishlist-member' ); ?>', name : 'uncancel_notification',
			type : 'toggle-switch', value: 1, uncheck_value: 0, 
			tooltip : '<?php esc_js_e( 'The Membership Uncancelled Notification will be sent to those who are uncancelled from a level', 'wishlist-member' ); ?>',
			tooltip_size: 'lg'
			}</template>
			<hr>
		</div>

...
var reset_settings = function () {
	...
	var x = $body.save_settings({
	    on_init: function( $me, $data) {
	    	$this_button.disable_button({disable:true, text:wlm.translate( 'Resetting...' ), icon:"update"});
	    ...
	    on_fail: function( $me, $data) {
	    	...
	    	$this_button.disable_button({disable:false, text:wlm.translate( 'Yes' ), icon:"delete"});
	    	console.log($data);
	    },

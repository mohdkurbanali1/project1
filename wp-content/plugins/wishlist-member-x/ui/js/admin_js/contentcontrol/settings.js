jQuery(function($){
	...
	$('body').on('change.wlm3-errorpages', '.auto-save', function() {
...
var show_modal = function() {
	...
	$("#" +modal_id).find(".modal-title").html(wlm.translate( 'Loading settings, please wait...' ));
	    ...
	    on_success: function( $me, $result) {
	    	if ( $result.success && $result.settings ) {
				...
				if ( $this_button.attr("key") == "archiver" ) {
					$("#" +modal_id).find(".modal-title").html(wlm.translate( 'Content Archiver Settings' ) );
					...
					$("#" +modal_id).find(".modal-title").html(wlm.translate( 'Content Scheduler Settings' ) );

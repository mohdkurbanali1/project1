...
class AWeberServiceProvider implements OAuthServiceProvider {
	...
	/**
	 * Location to request an access token
	 *
	 * @var String
	 */
	...
	/**
	 * Location to authorize an Application
	 *
	 * @var String
	 */
	...
	/**
	 * Location to request a request token
	 *
	 * @var String
	 */
...
class AWeberAPIBase {
	 ...
	 * contains.
	 */
	protected static $_collectionMap = array(
...
return $this->adapter->user;
		...
		trigger_error(esc_html("Could not find \"{$item}\""));
	}

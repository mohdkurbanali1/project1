 ...
 * @property null|\WLMStripe\StripeObject $address The customer's address.
 ...
 * @property null|\WLMStripe\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property \WLMStripe\StripeObject $invoice_settings
 ...
 * @property null|\WLMStripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \WLMStripe\Collection $sources The customer's payment sources, if any.
 * @property null|\WLMStripe\Collection $subscriptions The customer's current subscriptions, if any.
 ...
 * @property \WLMStripe\Collection $tax_ids The customer's tax IDs.
 */
class Customer extends ApiResource {
	 ...
	 *
	 * @return \WLMStripe\Customer the updated customer
	 */
	 ...
	 *
	 * @return \WLMStripe\Collection the list of customer balance transactions
	 */
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\CustomerBalanceTransaction
	 */
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\Collection the list of payment sources (AlipayAccount, BankAccount, BitcoinReceiver, Card or Source)
	 */
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\AlipayAccount|\WLMStripe\BankAccount|\WLMStripe\BitcoinReceiver|\WLMStripe\Card|\WLMStripe\Source
	 */
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\Collection the list of tax ids
	 */

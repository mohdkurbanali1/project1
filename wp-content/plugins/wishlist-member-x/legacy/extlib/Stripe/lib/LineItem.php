 ...
 * @property \WLMStripe\StripeObject[] $discounts The discounts applied to the line item.
 ...
 * @property \WLMStripe\StripeObject[] $taxes The taxes applied to the line item.
 */

 ...
 * @property null|\WLMStripe\StripeObject $business_profile Business information about the account.
 * @property null|string $business_type The business type.
 * @property \WLMStripe\StripeObject $capabilities
 * @property bool $charges_enabled Whether the account can create live charges.
 * @property \WLMStripe\StripeObject $company
 ...
 * @property \WLMStripe\Collection $external_accounts External accounts (bank accounts and debit cards) currently attached to this account
 * @property \WLMStripe\Person $individual <p>This is an object representing a person associated with a Stripe account.</p><p>Related guide: <a href="https://stripe.com/docs/connect/identity-verification-api#person-information">Handling Identity Verification with the API</a>.</p>
 ...
 * @property \WLMStripe\StripeObject $requirements
 * @property null|\WLMStripe\StripeObject $settings Options for customizing how the account functions within Stripe.
 * @property \WLMStripe\StripeObject $tos_acceptance
...
class Account extends ApiResource {
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\StripeObject object containing the response from the API
	 */
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\Collection the list of persons
	 */
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\Collection the list of capabilities
	 */
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\Collection the list of external accounts (BankAccount or Card)
	 */
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\BankAccount|\WLMStripe\Card
	 */

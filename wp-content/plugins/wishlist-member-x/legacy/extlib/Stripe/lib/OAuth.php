...
abstract class OAuth {
	...
	public static function authorizeUrl( $params = null, $opts = null) {
		...
		$base = ( $opts && \array_key_exists('connect_base', $opts) ) ? $opts['connect_base'] : WLM_Stripe::$connectBase;
	...
	private static function _getClientId( $params = null) {
		...
		if (null === $clientId) {
			$clientId = WLM_Stripe::getClientId();
		}
		if (null === $clientId) {
			$msg = 'No client_id provided.  (HINT: set your client_id using '
			  . '"WLM_Stripe::setClientId(<CLIENT-ID>)".  You can find your client_ids '

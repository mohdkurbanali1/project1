 ...
 * @property null|\WLMStripe\Collection $links A list of <a href="https://stripe.com/docs/api#file_links">file links</a> that point at this file.
...
class File extends ApiResource {
	 ...
	 *
	 * @return \WLMStripe\File the created file
	 */
	public static function create( $params = null, $opts = null) {
		$opts = \WLMStripe\Util\RequestOptions::parse($opts);
		if (null === $opts->apiBase) {
			$opts->apiBase = WLM_Stripe::$apiUploadBase;
		}

 ...
 * @property string|\WLMStripe\Customer $customer ID of the customer.
 * @property null|string|\WLMStripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property string|\WLMStripe\Invoice $invoice ID of the invoice.
 * @property \WLMStripe\Collection $lines Line items that make up the credit note
 ...
 * @property null|string|\WLMStripe\Refund $refund Refund related to this credit note.
 ...
 * @property \WLMStripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource {
	 ...
	 *
	 * @return \WLMStripe\CreditNote the previewed credit note
	 */
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\Collection the list of credit note line items
	 */

...
abstract class ApiErrorException extends \Exception implements ExceptionInterface {
	 ...
	 * @param null|array|\WLMStripe\Util\CaseInsensitiveArray $httpHeaders the HTTP headers array
	 ...
	 *
	 * @return null|\WLMStripe\ErrorObject
	 */
	 ...
	 *
	 * @param null|\WLMStripe\ErrorObject $error
	 */
	 ...
	 *
	 * @return null|array|\WLMStripe\Util\CaseInsensitiveArray
	 */
	 ...
	 *
	 * @param null|array|\WLMStripe\Util\CaseInsensitiveArray $httpHeaders
	 */
	 ...
	 *
	 * Cf. the `CODE_*` constants on {@see \WLMStripe\ErrorObject} for possible
	 * values.
	 *
	 * @return null|string
	 */
	...
	protected function constructErrorObject() {
		...
		return \WLMStripe\ErrorObject::constructFrom($this->jsonBody['error']);
	}
}

 ...
 * @property null|string|\WLMStripe\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\WLMStripe\Account $destination ID of the Stripe account the transfer was sent to.
 * @property string|\WLMStripe\Charge $destination_payment If the destination is a Stripe account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \WLMStripe\Collection $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\WLMStripe\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource {
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\Collection the list of transfer reversals
	 */
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\TransferReversal
	 */

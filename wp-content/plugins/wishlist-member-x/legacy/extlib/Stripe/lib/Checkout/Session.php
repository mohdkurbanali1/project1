 ...
 * @property \WLMStripe\StripeObject[] $display_items The line items, plans, or SKUs purchased by the customer. Prefer using <code>line_items</code>.
 * @property \WLMStripe\Collection $line_items The line items purchased by the customer.
 ...
 * @property null|string|\WLMStripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 ...
 * @property null|string|\WLMStripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\WLMStripe\StripeObject $shipping Shipping information for this Checkout Session.
 * @property null|\WLMStripe\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 ...
 * @property null|string|\WLMStripe\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|\WLMStripe\StripeObject $total_details Tax and discount details for the computed total amount.
 */
class Session extends \WLMStripe\ApiResource {

	const OBJECT_NAME = 'checkout.session';

	use \WLMStripe\ApiOperations\All;
	use \WLMStripe\ApiOperations\Create;
	use \WLMStripe\ApiOperations\NestedResource;
	 ...
	 *
	 * @return \WLMStripe\Collection the list of items
	 */

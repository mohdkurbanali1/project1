 ...
 * @property string|\WLMStripe\Customer $customer The ID of the customer who will be billed when this invoice item is billed.
 ...
 * @property null|string|\WLMStripe\Invoice $invoice The ID of the invoice this invoice item belongs to.
 ...
 * @property \WLMStripe\StripeObject $period
 * @property null|\WLMStripe\Plan $plan If the invoice item is a proration, the plan of the subscription that the proration was computed for.
 * @property null|\WLMStripe\Price $price The price of the invoice item.
 ...
 * @property null|string|\WLMStripe\Subscription $subscription The subscription that this invoice item has been created for, if any.
 * @property string $subscription_item The subscription item that this invoice item has been created for, if any.
 * @property null|\WLMStripe\TaxRate[] $tax_rates The tax rates which apply to the invoice item. When set, the <code>default_tax_rates</code> on the invoice do not apply to this invoice item.

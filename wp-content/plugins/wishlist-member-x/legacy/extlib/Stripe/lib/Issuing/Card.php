 ...
 * @property null|string|\WLMStripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\WLMStripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\WLMStripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \WLMStripe\StripeObject $spending_controls
...
class Card extends \WLMStripe\ApiResource {
	 ...
	 *
	 * @return \WLMStripe\Issuing\CardDetails the card details associated with that issuing card
	 */

 ...
 * @property null|string|\WLMStripe\Issuing\Authorization $authorization The <code>Authorization</code> object that led to this transaction.
 * @property null|string|\WLMStripe\BalanceTransaction $balance_transaction ID of the <a href="https://stripe.com/docs/api/balance_transactions">balance transaction</a> associated with this transaction.
 * @property string|\WLMStripe\Issuing\Card $card The card used to make this transaction.
 * @property null|string|\WLMStripe\Issuing\Cardholder $cardholder The cardholder to whom this transaction belongs.
 ...
 * @property null|\WLMStripe\StripeObject $purchase_details Additional purchase information that is optionally provided by the merchant.

 ...
 * @property \WLMStripe\StripeObject[] $tax_amounts The amount of tax calculated per tax rate for this line item
 * @property \WLMStripe\TaxRate[] $tax_rates The tax rates which apply to the line item.

 ...
 * @property null|\WLMStripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\WLMStripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \WLMStripe\StripeObject $dob
 ...
 * @property \WLMStripe\StripeObject $relationship
 * @property null|\WLMStripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \WLMStripe\StripeObject $verification
 */

 ...
 * @property \WLMStripe\StripeObject $ach_credit_transfer
 * @property \WLMStripe\StripeObject $ach_debit
 * @property \WLMStripe\StripeObject $acss_debit
 * @property \WLMStripe\StripeObject $alipay
 ...
 * @property \WLMStripe\StripeObject $code_verification
 ...
 * @property \WLMStripe\StripeObject $klarna
 ...
 * @property \WLMStripe\StripeObject $multibanco
 * @property null|\WLMStripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \WLMStripe\StripeObject $p24
 * @property \WLMStripe\StripeObject $receiver
 * @property \WLMStripe\StripeObject $redirect
 * @property \WLMStripe\StripeObject $sepa_credit_transfer
 * @property \WLMStripe\StripeObject $sepa_debit
 * @property \WLMStripe\StripeObject $sofort
 * @property \WLMStripe\StripeObject $source_order
 ...
 * @property \WLMStripe\StripeObject $three_d_secure
 ...
 * @property \WLMStripe\StripeObject $wechat
 */
class Source extends ApiResource {
	 ...
	 *
	 * @throws \WLMStripe\Exception\UnexpectedValueException if the source is not attached to a customer
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\Source the detached source
	 */
	 ...
	 * @throws \WLMStripe\Exception\ApiErrorException if the request fails
	 *
	 * @return \WLMStripe\Collection the list of source transactions
	 */

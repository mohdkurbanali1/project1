...
$endDate = wlm_date("Y-m-d\TH:i:sO", mktime(0,0,0,wlm_date('m',$endDate),wlm_date('d',$endDate),wlm_date('Y',$endDate)));
$startDate = strtDate($endDate, 1);

function strtDate($orgDate,$dy){
	$cd = strtotime($orgDate);
	$retDAY = wlm_date("Y-m-d\TH:i:sO", mktime(0,0,0,wlm_date('m',$cd),wlm_date('d',$cd)-$dy,wlm_date('Y',$cd)));
	return $retDAY;
}

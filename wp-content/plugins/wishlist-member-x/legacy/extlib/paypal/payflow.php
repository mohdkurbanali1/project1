...
class PayFlow extends PPayflow { 
	 ...
	 */
	public function GetTransactionStateCodeMessage( $Code) {
	...
	public function CURLRequest( $Request = '', $APIName = '', $APIOperation = '', $PrintHeaders = false) {
		...
		$unique_id = wlm_date('ymd-His') . rand(1000, 9999);
	 ...
	 */
	public function ProcessTransaction( $DataArray) {
